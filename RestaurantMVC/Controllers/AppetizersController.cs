...
namespace RestaurantMVC.Controllers
{
    ...
    public class AppetizersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "AppetizerID,Title,Description,Price")] Appetizer appetizer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "AppetizerID,Title,Description,Price")] Appetizer appetizer)
        {
            if (ModelState.IsValid)
            {
